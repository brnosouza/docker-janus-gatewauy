...
var server = window.location.protocol === "http:"
    ? "ws://" + window.location.hostname + ":8288"
    : "wss://" + window.location.hostname + ":8289";
                ...
                janus = new Janus(
                    {
                        ...
                        // iceServers: [{urls: "turn:numb.viagenie.ca:443", username: "brnosouza@gmail.com", credential: "greenBeever360"}],
